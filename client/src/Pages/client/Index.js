            ...
            <div className="g-4 items-center row">
              <div className="lg-7">
                <div className="pe-xl-5 row">
                  <div className="sm-6">
                    <img
                      src={`../../../resources/images/about/office-1.jpg`}
                      className="rounded"
                      alt="about-img"
                      loading="lazy"
                    />
                  ...
                  <div className="sm-6">
                    ...
                    <img
                      src={`../../../resources/images/about/office-2.jpg`}
                      className="rounded"
                      alt="about-img-2"
                      loading="lazy"
                    />
              ...
              <div className="lg-5 mt30">
                <span className="bg-light rounded-3 px-3 py-2">
                  🤝 Your gateway to digital success
                </span>
                <h2 className="my-4 common-title">
                  Defining the future of online experiences!
                </h2>
                <p className="mb-4">
                  Embrace a new era of digital success with Rizqnet Solutions.
                  Our team combines cutting-edge design with robust development
                  to deliver websites that captivate and convert.
                </p>
                ...
                <div className="mt30">
                  <a
                    className="rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm btn-secondary mb-0"
                    href="#"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
                <div className="service-card h-100">
                  ...
                  <div className="card-dark-bg mt-auto card-footer">
                    <a className="card-icon-link" href="#">
                      Read more{" "}
                      <svg
                        stroke={colours.primary}
                        fill={colours.primary}
